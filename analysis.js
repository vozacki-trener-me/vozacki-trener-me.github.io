const analysisUi={
cnr:{copy:'⧉ Kopiraj pitanje',copied:'✓ Kopirano',open:'☷ Sva pitanja i odgovori',title:'Sva pitanja i odgovori',search:'Pretraga pitanja i odgovora na svim jezicima',copyAll:'⧉ Kopiraj spisak',count:n=>`${n} pitanja`,correct:'Tačan odgovor',close:'Zatvori'},
ru:{copy:'⧉ Скопировать вопрос',copied:'✓ Скопировано',open:'☷ Все вопросы и ответы',title:'Все вопросы и ответы',search:'Поиск вопросов и ответов на всех языках',copyAll:'⧉ Скопировать список',count:n=>`${n} ${n%10===1&&n%100!==11?'вопрос':n%10>=2&&n%10<=4&&(n%100<10||n%100>=20)?'вопроса':'вопросов'}`,correct:'Правильный ответ',close:'Закрыть'},
en:{copy:'⧉ Copy question',copied:'✓ Copied',open:'☷ All questions and answers',title:'All questions and answers',search:'Search questions and answers in all languages',copyAll:'⧉ Copy list',count:n=>`${n} questions`,correct:'Correct answer',close:'Close'},
de:{copy:'⧉ Frage kopieren',copied:'✓ Kopiert',open:'☷ Alle Fragen und Antworten',title:'Alle Fragen und Antworten',search:'Fragen und Antworten in allen Sprachen suchen',copyAll:'⧉ Liste kopieren',count:n=>`${n} Fragen`,correct:'Richtige Antwort',close:'Schließen'}
};
